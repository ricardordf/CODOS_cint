...
void loop() {
  ...
  int id = 1;
  String tipo = "Presion Atmosferica";

//  char INSERT_SQL[] = "INSERT INTO bdrdelgado.datos_sensores (id_sensor, tipo, valor) VALUES (1, 'Presion atmosferica',4.3);";
  char INSERT_SQL[] = "INSERT INTO bdrdelgado.datos_sensores (id_sensor, tipo, valor) VALUES (%d, %s, %lf);";
  char query[255];
  sprintf(query, INSERT_SQL, id, tipo, presion);
